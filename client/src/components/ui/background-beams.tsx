    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{
                    boxShadow:
                        "0 0 24px rgba(185, 28, 28, 0.06), 0 1px 1px rgba(185, 28, 28, 0.06), 0 0 0 1px rgba(185, 28, 28, 0.06), 0 0 4px rgba(185, 28, 28, 0.06), 0 16px 68px rgba(185, 28, 28, 0.06), 0 1px 0 rgba(185, 28, 28, 0.06) inset",
                }}
            ></div>
        </div>
    );
    ...
    return (
        <>
            <motion.div
                ...
                className={cn(
                    "absolute left-0 top-20 m-auto h-14 w-px rounded-full bg-gradient-to-t from-red-500 via-red-600 to-transparent",
